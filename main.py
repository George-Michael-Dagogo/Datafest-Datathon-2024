...
dim_class_resources.to_csv('./data/class_resources_table.csv', index=False)
dim_student.to_csv('./data/student_table.csv', index=False)
dim_parent_demographics.to_csv('./data/parent_table.csv', index=False)
dim_extracurricular_activity.to_csv('./data/extracurricular_activity.csv', index=False)
...
fact_attendance.to_csv('./data/attendance_table.csv', index=False)
ss3_student_survey.to_csv('./data/ss3_student_survey.csv', index=False)